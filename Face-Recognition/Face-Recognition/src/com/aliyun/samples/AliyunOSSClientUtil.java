	...
	*/      
    ...
    public static  String uploadObject2OSS(OSSClient ossClient, File file, String bucketName, String folder) {  
        ...
        try {  
            ...
            if(resultStr != null){
            	String resultUrl = "http://face--recognition.oss-cn-shanghai.aliyuncs.com/"+fileName;
            	return resultUrl;
            }
        } catch (Exception e) {  
            e.printStackTrace();  
    ...
    public static void main(String[] args) {  
        ...
        //上传文件  
        String files="C:\\Users\\hclmaster\\Desktop\\人脸识别\\Android-facerecognition-原型设计\\轮播图\\压缩后的\\轮播图1.png";  
        String[] file=files.split(",");  
        for(String filename:file){  
            //System.out.println("filename:"+filename);  
            File filess=new File(filename);  
            String resultUrl = AliyunOSSClientUtil.uploadObject2OSS(ossClient, filess, BACKET_NAME, FOLDER);    
