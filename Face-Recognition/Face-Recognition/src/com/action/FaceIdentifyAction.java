...
import com.hcl.faceUtils.FaceIdentifyUtils;
import com.opensymphony.xwork2.ActionSupport;

public class FaceIdentifyAction extends ActionSupport {
	private static final long serialVersionUID = 1L;
	
	public FaceIdentifyUtils faceIdentifyUtils = new FaceIdentifyUtils();
	...
	public String search() throws Exception{
		...
		for(int i=0;i<file.size();++i){
			...
			url = faceIdentifyUtils.FaceIdentify(PicPath);
			is.close();
			os.close();
		}
		for(int i=0;i<10;i++){
